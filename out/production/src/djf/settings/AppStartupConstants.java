...
public class AppStartupConstants {
    ...
    public static final String APP_PROPERTIES_FILE_NAME_ENGLISH = "app_properties.xml";
    public static final String APP_PROPERTIES_FILE_NAME_SPANISH = "app_properties_es.xml";
    ...
    public static String PROPERTIES_FILE_ERROR_MESSAGE = "Error Loading app properties";
